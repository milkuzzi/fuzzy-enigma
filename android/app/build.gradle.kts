...
android {
    namespace = "com.studydungeon"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.studydungeon"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    // The domain layer is pure Kotlin/JVM; unit tests (incl. property-based)
    // run on the local JVM via the test source set.
    testOptions {
        unitTests.all {
            it.useJUnitPlatform()
        }
